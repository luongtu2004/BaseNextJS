...
VALUES 
('c0eebc99-9c0b-4ef8-bb6d-6bb9bd380c01', 'tintuc', 'Tin tức', 'tin-tuc', true),
('c0eebc99-9c0b-4ef8-bb6d-6bb9bd380c02', 'khuyenmai', 'Khuyến mãi', 'khuyen-mai', true),
('c0eebc99-9c0b-4ef8-bb6d-6bb9bd380c03', 'congdong', 'Cộng đồng', 'cong-dong', true),
('c0eebc99-9c0b-4ef8-bb6d-6bb9bd380c04', 'congnghe', 'Công nghệ', 'cong-nghe', true)
ON CONFLICT (code) DO UPDATE SET 
    name = EXCLUDED.name,
    slug = EXCLUDED.slug;

-- 2. TẠO BÀI VIẾT (POSTS)
INSERT INTO posts (category_id, title, slug, summary, content, cover_image_url, status, visibility, post_type, is_featured)
VALUES 
-- Bài viết 1: Tin tức
(

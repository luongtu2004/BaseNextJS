...
export default function NavbarWithAdmin() {
      ...
      <div className="max-w-[1740px] mx-auto px-4 md:px-8 h-full flex items-center justify-between relative">
        <div className="flex items-center gap-10">
          ...
          <div className="hidden md:flex items-center gap-8 h-full">
            ...
            <Link href="/admin" className="text-[13px] font-medium text-slate-500 hover:text-slate-900 transition-colors">Quản trị</Link>
          </div>
        </div>

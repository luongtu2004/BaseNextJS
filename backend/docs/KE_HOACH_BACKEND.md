...
|-------|------------|-----------|---------------|---------|
| Phase 1 — Auth + Common | Hoàn thành | 0.1.0 | 2026-03-23 | `/health`, `/health/db` OK |
| Phase 2 — Admin | Hoàn thành | 0.2.0 | 2026-03-23 | Full Admin API: taxonomy, users, providers, posts |
| Phase 3 — Customer | Hoàn thành | 0.1.0 | 2026-03-25 | Taxonomy, Provider Search OK |
| Phase 4 — Provider Owner | Hoàn thành | 0.1.0 | 2026-03-25 | Profile, Services Management OK |

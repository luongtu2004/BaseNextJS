          ...
          {PILLARS.map((pillar, index) => {
            ...
            return (
              <motion.div
                ...
                transition={{ 
                  duration: 1.2, 
                  ease: [0.22, 1, 0.36, 1], // Custom "Antigravity" cubic-bezier for a floaty feel
                  delay: 0.1 
                }}
              ...
              >
                ...
                {/* Clear Image Container (Antigravity & Clear Mask) */}

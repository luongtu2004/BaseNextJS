...
| Phase 6 — Vận tải & Logistics | Đang làm | 0.4.0 | 2026-04-03 | Taxonomy seed → Vehicles → Routes → Rental. |
...
**Việc cần làm:**
- [ ] Tạo `sql/seed_taxonomy_vantai.sql` — 15 `service_categories` cho nhóm `vantaidichuyen`
- [ ] Seed `service_category_attributes` (~120 records)
- [ ] Seed `service_category_requirements` (~45 records)
- [ ] Seed `service_skills`
- [ ] Verify qua `/api/v1/customer/industry-categories`
...
| # | Method | Path | Notes | Trạng thái |
|---|--------|------|-------|------------|
| V1 | POST | `/api/v1/provider/vehicles` | Thêm xe mới | TODO |
| V2 | GET | `/api/v1/provider/vehicles` | Danh sách xe của tôi | TODO |
| V3 | GET | `/api/v1/provider/vehicles/{id}` | Chi tiết xe | TODO |
| V4 | PUT | `/api/v1/provider/vehicles/{id}` | Cập nhật xe | TODO |
| V4b | PATCH | `/api/v1/provider/vehicles/{id}/status` | Kích hoạt / tạm ngừng xe | TODO |
| V5 | DELETE | `/api/v1/provider/vehicles/{id}` | Xóa xe | TODO |
| V6 | GET | `/api/v1/provider/vehicles/{id}/documents` | Danh sách giấy tờ xe | TODO |
| V7 | POST | `/api/v1/provider/vehicles/{id}/documents` | Thêm giấy tờ xe | TODO |
| V8 | GET | `/api/v1/provider/vehicles/{id}/documents/{doc_id}` | Chi tiết giấy tờ xe | TODO |
| V9 | PUT | `/api/v1/provider/vehicles/{id}/documents/{doc_id}` | Cập nhật giấy tờ xe | TODO |
| V10 | DELETE | `/api/v1/provider/vehicles/{id}/documents/{doc_id}` | Xóa giấy tờ xe | TODO |

#### MODULE A — Admin Vehicles

| # | Method | Path | Notes | Trạng thái |
|---|--------|------|-------|------------|
| AV1 | GET | `/api/v1/admin/vehicles` | Danh sách tất cả xe | TODO |
| AV2 | GET | `/api/v1/admin/vehicles/{id}` | Chi tiết xe | TODO |
| AV3 | PATCH | `/api/v1/admin/vehicles/{id}/status` | Kích hoạt / khóa xe | TODO |
| AV4 | GET | `/api/v1/admin/vehicle-documents` | Queue giấy tờ xe chờ duyệt | TODO |
| AV5 | POST | `/api/v1/admin/vehicle-documents/{doc_id}/review` | Duyệt / từ chối giấy tờ xe | TODO |
...
| # | Method | Path | Notes | Trạng thái |
|---|--------|------|-------|------------|
| R1 | POST | `/api/v1/provider/services/{svc_id}/routes` | Tạo tuyến → `service_routes` | TODO |
| R2 | GET | `/api/v1/provider/services/{svc_id}/routes` | Danh sách tuyến | TODO |
| R2b | GET | `/api/v1/provider/services/{svc_id}/routes/{id}` | Chi tiết tuyến | TODO |
| R3 | PUT | `/api/v1/provider/services/{svc_id}/routes/{id}` | Cập nhật tuyến | TODO |
| R3b | PATCH | `/api/v1/provider/services/{svc_id}/routes/{id}/status` | Bật / tắt tuyến | TODO |
| R4 | DELETE | `/api/v1/provider/services/{svc_id}/routes/{id}` | Xóa tuyến | TODO |
| R5 | POST | `/api/v1/provider/routes/{route_id}/schedules` | Thêm lịch → `service_route_schedules` | TODO |
| R6 | GET | `/api/v1/provider/routes/{route_id}/schedules` | Danh sách lịch | TODO |
| R7 | PUT | `/api/v1/provider/routes/{route_id}/schedules/{id}` | Cập nhật lịch | TODO |
| R7b | PATCH | `/api/v1/provider/routes/{route_id}/schedules/{id}/status` | Bật / tắt lịch | TODO |
| R8 | DELETE | `/api/v1/provider/routes/{route_id}/schedules/{id}` | Xóa lịch | TODO |

#### MODULE C — Customer Transport Search

| # | Method | Path | Notes | Trạng thái |
|---|--------|------|-------|------------|
| CT1 | GET | `/api/v1/customer/transport/search` | Tìm provider theo loại + khu vực | TODO |
| CT2 | GET | `/api/v1/customer/transport/routes` | Tìm tuyến xe (from → to + ngày) | TODO |
| CT3 | GET | `/api/v1/customer/transport/routes/{id}` | Chi tiết tuyến + danh sách lịch khởi hành | TODO |

#### MODULE A — Admin Routes

| # | Method | Path | Notes | Trạng thái |
|---|--------|------|-------|------------|
| AR1 | GET | `/api/v1/admin/routes` | Tất cả tuyến đường | TODO |
| AR2 | GET | `/api/v1/admin/routes/{id}` | Chi tiết tuyến + lịch khởi hành | TODO |
| AR3 | PATCH | `/api/v1/admin/routes/{id}/status` | Bật / tắt tuyến | TODO |
...
| # | Method | Path | Notes | Trạng thái |
|---|--------|------|-------|------------|
| RA1 | GET | `/api/v1/provider/vehicles/{id}/availabilities` | Xem lịch → `provider_vehicle_availabilities` | TODO |
| RA2 | POST | `/api/v1/provider/vehicles/{id}/availabilities/block` | Block ngày không cho thuê | TODO |
| RA3 | POST | `/api/v1/provider/vehicles/{id}/availabilities/unblock` | Mở lại ngày | TODO |

#### MODULE C — Customer Rental

| # | Method | Path | Notes | Trạng thái |
|---|--------|------|-------|------------|
| CR1 | GET | `/api/v1/customer/transport/rental-vehicles` | Tìm xe cho thuê (loại + ngày + khu vực) | TODO |
| CR1b | GET | `/api/v1/customer/transport/rental-vehicles/{id}` | Chi tiết xe cho thuê | TODO |
| CR2 | GET | `/api/v1/customer/transport/rental-vehicles/{id}/availabilities` | Kiểm tra lịch trống | TODO |
